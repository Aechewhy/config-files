--- STEAMODDED HEADER
--- MOD_NAME: Buddies of Scruby PACK 2
--- MOD_ID: bos_deck_2
--- PREFIX: bos
--- MOD_AUTHOR: [Scruby, Gatler, DoubleV]
--- MOD_DESCRIPTION: Various indie card skins!
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.1
--- BADGE_COLOR: FF3800 

local atlas_key = 'bos_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'bos_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'bos_hc.png' -- Filename for the high-contrast version of the texture, if existing

local suits = {'hearts', 'clubs', 'diamonds', 'spades'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King", "Ace"} -- Which ranks to replace

local descriptions = {'Fight Knight', 'Atlyss', 'Hylics', 'Steven Universe'} -- English-language description, in order of suits
