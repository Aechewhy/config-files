LOVELY_INTEGRITY = '6e88e718820dd2587936f29ffe61b54764afb1e0f2d2274b8e64f52bc3d5d269'
...
function juice_card_until(card, eval_func, first, delay)
    G.E_MANAGER:add_event(Event({
        ...
        func = (function() if eval_func(card) then if not first or first then Saturn.prevent_animation_skip = true; card:juice_up(0.1, 0.1); Saturn.prevent_animation_skip = false; end;juice_card_until(card, eval_func, nil, 0.8) end return true end)
    }))
end
