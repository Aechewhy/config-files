...
local atlas_key = 'fos_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'fos_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'fos_hc.png' -- Filename for the high-contrast version of the texture, if existing

local suits = {'hearts', 'clubs', 'diamonds', 'spades'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King", "Ace"} -- Which ranks to replace

local descriptions = {'UFO 50', 'Animal Well', 'Pizza Tower', 'Changed'} -- English-language description, in order of suits
